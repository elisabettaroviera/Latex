...
\subsection{Outlier modelling and variance-based instability}
...
\subsection{Baseline classification: Normal vs.\ Tumor}
...
\subsection{Link between entropy, outlier burden, and the epigenetic score}
