...
% -------------------------------------------------------
\section{Synthesis: A Progressive Epigenetic Model of Breast Carcinogenesis}
% -------------------------------------------------------

The biological evidence reviewed in this chapter converges on a coherent and
testable model. Breast carcinogenesis is not a sudden event but a progressive
deviation from epigenetic homeostasis, driven by the interplay of aging, stochastic
drift, and selective pressures operating across a population of cells.
...
field defects emerge. Adjacent tissue, which is histologically indistinguishable
from normal tissue, harbors a measurable epigenetic signature of this
reprogramming — detectable predominantly as increased variability rather than
directional methylation change. As carcinogenesis proceeds, this heterogeneous
pre-malignant state converges toward a more consolidated malignant epigenetic
configuration characterized by focal hypermethylation of tumor-suppressive loci
and global hypomethylation.

This model has several important consequences for the design of computational
analyses:

First, tissue classification along the Normal–Adjacent–Tumor axis should be
approached as a continuous-spectrum problem rather than a binary discrimination
task. The intermediate adjacent state is biologically distinct from both extremes
and warrants explicit characterization.

Second, feature selection for this problem must be sensitive to variance differences
and not only to mean differences. Epigenetic field defects are by definition
heterogeneous signals that may not survive standard mean-based filtering.

Third, reproducibility of any identified signature across independent cohorts is
a key validation criterion. Field defects are expected to be partially stochastic
across individuals; signatures that replicate across datasets are thus more likely
to reflect genuine biology rather than cohort-specific noise.

These considerations directly motivate the preprocessing framework, feature
selection strategies, and cross-cohort validation design developed in the
following chapters.
