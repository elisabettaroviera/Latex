...
burden, instability is strongly directional: the dominant pattern is focal hypomethylation, especially
in Tumor samples, while Adjacent tissues show a milder but consistent excess of negative $\Delta\beta$
values. Variance distributions further support this picture, with Tumor samples exhibiting a heavier
tail and Adjacent tissues differing from Normal without forming a simple intermediate pattern.
...
contrast is therefore not strongly marked in GSE225845, reinforcing the interpretation that early
...
\begin{figure}[t]
    ...
    \caption{
        ...
        across GSE69914, GSE225845, and GSE287331. }
