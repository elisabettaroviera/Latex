...
\begin{itemize}[label=-]
  \item \href{https://github.com/elisabettaroviera/THESIS/blob/main/01%20-%20Notebook/00%20-%20Dataset%20Construction%20%26%20Metadata/GSE69914/00-dataset-preparation-GSE69914.ipynb}{\texttt{00-dataset-preparation-GSE69914.ipynb}} — GSE69914 $\beta$-value matrix ingestion and labeling.

  \item \href{https://github.com/elisabettaroviera/THESIS/blob/main/01%20-%20Notebook/00%20-%20Dataset%20Construction%20%26%20Metadata/GSE69914/00-dataset-metadata-GSE69914.ipynb}{\texttt{00-dataset-metadata-GSE69914.ipynb}} — Metadata extraction for GSE69914.

  \item \href{https://github.com/elisabettaroviera/THESIS/blob/main/01%20-%20Notebook/00%20-%20Dataset%20Construction%20%26%20Metadata/GSE225845/00-dataset-preparation-GSE225845.ipynb}{\texttt{00-dataset-preparation-GSE225845.ipynb}} — GSE225845 $\beta$-value streaming ingestion and merging.

  \item \href{https://github.com/elisabettaroviera/THESIS/blob/main/01%20-%20Notebook/00%20-%20Dataset%20Construction%20%26%20Metadata/GSE225845/00-dataset-metadata-GSE225845.ipynb}{\texttt{00-dataset-metadata-GSE225845.ipynb}} — Metadata extraction for GSE225845.

  \item \href{https://github.com/elisabettaroviera/THESIS/blob/main/01%20-%20Notebook/00%20-%20Dataset%20Construction%20%26%20Metadata/GSE287331/00-dataset-preparation-GSE287331.ipynb}{\texttt{00-dataset-preparation-GSE287331.ipynb}} — GSE287331 $\beta$-value matrix ingestion.

  \item \href{https://github.com/elisabettaroviera/THESIS/blob/main/01%20-%20Notebook/00%20-%20Dataset%20Construction%20%26%20Metadata/GSE287331/00-dataset-metadata-GSE287331.ipynb}{\texttt{00-dataset-metadata-GSE287331.ipynb}} — Metadata extraction for GSE287331.
...
\paragraph{Metadata mismatch and filtering.}
The phenotype table originally contained 595 entries, each associated with an \texttt{idat\_basename} and interpreted as an individual sample.  
However, the processed $\beta$-value matrix provided by the authors includes only 402 samples.  
To ensure consistency between metadata and methylation values, the phenotype table was filtered to retain only those entries whose sample identifiers (\texttt{idat\_basename}) appear in the $\beta$-value matrix.  
This step guarantees a one-to-one correspondence between the methylation matrix and the phenotype table and ensures that all downstream analyses rely exclusively on samples for which both metadata and $\beta$-values are available.
...
\begin{itemize}[label=-]
  ...
  \item \texttt{tissue\_type\_raw} — raw tissue class parsed from \texttt{characteristics\_ch1} (HDB, AN, TU, OQ, CUB);
  ...
  \item \texttt{label} — five-class numeric encoding:
    \begin{itemize}[label=--]
      \item \texttt{0 = HDB} (healthy donated breast),
      \item \texttt{1 = AN}  (adjacent-normal breast tissue),
      \item \texttt{2 = TU}  (tumor tissue),
      \item \texttt{3 = OQ}  (ipsilateral opposite quadrant),
      \item \texttt{4 = CUB} (contralateral unaffected breast).
    \end{itemize}
\end{itemize}

The \texttt{label} field was cast to \texttt{Int8} to minimize storage, and the full table was saved as an LZ4-compressed Parquet file.
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\linewidth]{Figures/BreastTissue.jpeg}
    \caption{Illustration of the five tissue categories which were collected.}
    \label{fig:breast_tissue}
\end{figure}
