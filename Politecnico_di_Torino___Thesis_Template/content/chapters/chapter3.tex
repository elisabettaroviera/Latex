...
\section{Chapter Overview and Methodological Objectives}
...
\subsection{Methylation Data Representation and Storage Format}
...
The overall data organization and computational design follow a multi-dataset analytical paradigm commonly adopted in recent large-scale DNA methylation studies, where cohort-specific analyses are complemented by cross-dataset comparisons to assess robustness and generalizability~\cite{Sokolov2024}.
...
\section{Synthesis and Motivation for Data Pre-Processing}
